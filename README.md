...
### MERN Stack Developer | React.js | Node.js 
  ...
  I love building clean, responsive, and functional web applications while improving my development skills every day 🚀

---

## 👩‍💻 About Me  
I am a MERN Stack Developer with hands-on experience in building full-stack web applications using React.js, Node.js, Express.js, and MongoDB.

I enjoy creating responsive user interfaces, building REST APIs, working with databases, and implementing authentication using JWT and cookies.

I also work with Redux Toolkit, TanStack Query, Axios, Tailwind CSS, and React Router.

I use Git, GitHub, Postman, and modern development tools to build, test, and deploy web applications.

I am always learning new technologies and working on projects to improve my development skills.
...
### 🎨 Styling
![Tailwind CSS](https://img.shields.io/badge/Tailwind_CSS-38B2AC?style=for-the-badge&logo=tailwind-css&logoColor=white)
![Responsive Design](https://img.shields.io/badge/Responsive_Design-333333?style=for-the-badge)
...
![Cookies](https://img.shields.io/badge/Cookies-7952B3?style=for-the-badge)
...
- Implement authentication using JWT and cookies
- Manage application state using Redux Toolkit
- Handle API data using TanStack Query and Axios
- Build responsive UIs using Tailwind CSS
- Test APIs using Postman
- Deploy applications using Render and Netlify
...
![Kajal Saini's GitHub Streak](https://streak-stats.demolab.com?user=kajalsaini0017)
